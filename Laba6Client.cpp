...
int main()
{
    ...
    CreateProcess(L"C:\\Users\\Степан\\Desktop\\Child\\x64\\Debug\\Laba6Client.exe", NULL, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &siStartInfo, &piProcInfo);
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        for (int j = 0; j <= i; j++) {
            printf(" %d", turn1.GetFirstEl());
            turn1.EjectionElemet();
        }
        printf("\n");
    }
    printf("\n");
